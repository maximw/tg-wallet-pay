...
class OrderPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'pay_link' => 'setPayLink',
        'direct_pay_link' => 'setDirectPayLink'
    ];
    ...
    protected static $getters = [
        ...
        'pay_link' => 'getPayLink',
        'direct_pay_link' => 'getDirectPayLink'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('direct_pay_link', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['direct_pay_link'] === null) {
            $invalidProperties[] = "'direct_pay_link' can't be null";
        }
     ...
     * Sets pay_link
     *
     * @param string $pay_link URL to be shown to the payer by the store. Сan be used in 'Telegram Bot' only. **Important:** this link can be opened ONLY in dialog with Telegram-bot specified in your Store, ONLY by user with `telegramUserId` specified in the Order.
     *
     * @return self
     */
    ...
    /**
     * Gets direct_pay_link
     *
     * @return string
     */
    public function getDirectPayLink()
    {
        return $this->container['direct_pay_link'];
    }

    /**
     * Sets direct_pay_link
     *
     * @param string $direct_pay_link URL to be shown to the payer by the store. Can be used in 'Telegram Bot' and 'Telegram Web App'. **Important:** this link can be opened ONLY in dialog with Telegram-bot specified in your Store, ONLY by user with `telegramUserId` specified in the Order.
     *
     * @return self
     */
    public function setDirectPayLink($direct_pay_link)
    {
        if (is_null($direct_pay_link)) {
            throw new \InvalidArgumentException('non-nullable direct_pay_link cannot be null');
        }
        $this->container['direct_pay_link'] = $direct_pay_link;
