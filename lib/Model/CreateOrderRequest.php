...
class CreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets return_url
     *
     * @param string|null $return_url Url to redirect after paying order.  Note: if you want to open your telegram WebApp (https://core.telegram.org/bots/webapps)  then you should use special link format here (https://core.telegram.org/api/links#named-bot-web-app-links).  Example: https://t.me/wallet/start?startapp\"
     *
     * @return self
     */
